...
const teamMembers = [
  {
    name: "Alex Chen",
    role: "Founder & CEO",
    bio: "Former Google engineer with 10+ years in software development. Passionate about building inclusive tech communities.",
    avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    social: {
      linkedin: "https://linkedin.com/in/alexchen",
      twitter: "https://twitter.com/alexchen",
      email: "alex@cracked.com"
    }
  },
  {
    name: "Sarah Johnson",
    role: "Head of Education",
    bio: "Computer Science professor and curriculum designer. Expert in making complex concepts accessible to all learners.",
    ...
    social: {
      ...
      email: "sarah@cracked.com"
    }
  },
  {
    name: "Marcus Rodriguez",
    role: "Lead Developer",
    bio: "Full-stack developer and open-source contributor. Builds the tools that power our learning platform.",
    avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    social: {
      linkedin: "https://linkedin.com/in/marcusrodriguez",
      twitter: "https://twitter.com/marcusrodriguez",
      email: "marcus@cracked.com"
    }
  },
  {
    name: "Emily Zhang",
    role: "Community Manager",
    bio: "Former developer advocate who believes in the power of community-driven learning and mentorship.",
    ...
    social: {
      ...
      email: "emily@cracked.com"
    }
  },
  {
    name: "David Kim",
    role: "Product Designer",
    bio: "UX designer focused on creating intuitive learning experiences. Passionate about human-centered design.",
    avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80",
    social: {
      linkedin: "https://linkedin.com/in/davidkim",
      twitter: "https://twitter.com/davidkim",
      email: "david@cracked.com"
    }
  },
  {
    name: "Lisa Wang",
    role: "Head of Operations",
    bio: "Operations expert with a background in scaling tech startups. Ensures everything runs smoothly behind the scenes.",
        ...
        <div className="text-center mt-20">
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-12 max-w-4xl mx-auto border border-white/20">
            ...
            <p className="text-xl text-gray-300 mb-8">
              We're always looking for passionate individuals who share our vision of empowering developers worldwide.
            </p>
            <a
              href="/careers"

...
const contactOptions = [
  {
    ...
    title: 'Mentors',
    description:
      'Share your expertise and guide aspiring developers on their journey.',
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-16'>
            {contactOptions.map((option, index) => (
              ...
              >
                {/* Icon */}
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${option.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                >
                ...
                {/* Email Button */}
                <div
                  className={`inline-flex items-center gap-2 bg-gradient-to-r ${option.color} text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 hover:scale-105 shadow-lg ${option.hoverColor}`}
                >
                ...
                {/* Decorative Element */}
                <div
                  className={`absolute top-4 right-4 w-8 h-8 bg-gradient-to-br ${option.color} rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                ></div>
              </div>
            ))}
          </div>

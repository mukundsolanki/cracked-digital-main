...
export const metadata: Metadata = {
  ...
  description: 'Learn about CRACKED\'s mission to democratize technical education and create a supportive ecosystem for developers worldwide. Discover our story, values, and team.',
  keywords: 'about CRACKED, technical education, developer community, tech story, community values, developer ecosystem',
  openGraph: {
